...
curl -X GET "http://localhost:8080/organization/info?id=1" \
...
<CodeGroup>
```bash Request Example
curl -X GET "http://localhost:8080/organization/getOrganizationTree?id=0" \
  -H "Authorization: Bearer {token}"
```
...
<CodeGroup>
```bash Request Example
curl -X GET "http://localhost:8080/organization/getAllOrganizationTreeByUser" \
  -H "Authorization: Bearer {token}"
```
</CodeGroup>
...
<CodeGroup>
```bash Request Example
curl -X GET "http://localhost:8080/organization/checkIsNameExist?id=0&name=Finance" \
  -H "Authorization: Bearer {token}"
```
